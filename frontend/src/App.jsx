...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      ...
      {/* Header */}
      <header className="relative z-10 bg-white/80 backdrop-blur-xl shadow-lg border-b border-gray-200/50 sticky top-0">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-200">
                ...
                <div className="text-left">
                  <p className="text-xs text-gray-600 leading-tight">Powered by</p>
                  <p className="text-sm font-bold text-indigo-700 leading-tight">Experian API</p>
                </div>
              </div>
            </div>
          </div>
